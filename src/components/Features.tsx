                  ...
                  <div className="p-6 bg-gray-50">
                    <div className="grid grid-cols-3 gap-2 md:gap-4">
                      <div className="bg-white rounded-lg p-4 text-center shadow-sm">
                        ...
                        <div className="text-lg md:text-xl font-bold text-gray-900 font-sans">127</div>
                      ...
                      <div className="bg-white rounded-lg p-4 text-center shadow-sm">
                        ...
                        <div className="text-lg md:text-xl font-bold text-gray-900 font-sans">94%</div>
                      ...
                      <div className="bg-white rounded-lg p-4 text-center shadow-sm">
                        ...
                        <div className="text-lg md:text-xl font-bold text-gray-900 font-sans">2.8d</div>
                  ...
                  <div className="p-6">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
                      {[
                        ...
                        <div key={index} className="border border-gray-200 rounded-lg p-3 md:p-4 hover:border-emerald-300 transition-colors cursor-pointer">
                          <div className="flex items-center mb-2">
                            <div 
                              className="w-6 h-6 md:w-8 md:h-8 rounded-lg flex items-center justify-center text-sm md:text-lg mr-2"
                              style={{ backgroundColor: `${template.color}20` }}
                            >
                              {template.icon}
                            </div>
                            <div>
                              <div className="font-medium text-gray-900 text-xs md:text-sm font-sans">{template.name}</div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 font-sans">Intuitive Checklist Builder</h3>
                </div>
                <p className="text-base md:text-lg text-gray-600 mb-6 font-sans">
                ...
                <div className="bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden">
                  ...
                  <div className="p-4 space-y-3">
                    {[
                      ...
                      <div key={index} className="bg-gray-50 border border-gray-200 rounded-lg p-2 md:p-3">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <span className="text-sm mr-2">{step.icon}</span>
                            <div>
                              <div className="font-medium text-gray-900 text-xs md:text-sm font-sans">{step.title}</div>
                              <div className="flex items-center mt-1">
                                <span className="px-1.5 py-0.5 bg-blue-100 text-blue-700 rounded-full text-xs font-sans">
                                  {step.type === 'textarea' ? 'Long Text' : 'File Upload'}
                                </span>
                                {step.required && (
                                  <span className="ml-1 md:ml-2 px-1.5 py-0.5 bg-red-100 text-red-700 rounded-full text-xs font-sans">
                                    Required
                                  </span>
                                )}
                              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 lg:order-2">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 font-sans">Seamless Customer Experience</h3>
                </div>
                <p className="text-base md:text-lg text-gray-600 mb-6 font-sans">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 font-sans">Customer Submissions Tracking</h3>
                </div>
                <p className="text-base md:text-lg text-gray-600 mb-6 font-sans">
                  ...
                  <div className="p-4 bg-gray-50 border-b border-gray-200">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-3">
                      <div className="text-center">
                        <div className="text-base md:text-lg font-bold text-gray-900 font-sans">12</div>
                        <div className="text-xs text-gray-600 font-sans">Total</div>
                      </div>
                      <div className="text-center">
                        <div className="text-base md:text-lg font-bold text-orange-600 font-sans">3</div>
                        <div className="text-xs text-gray-600 font-sans">Pending</div>
                      </div>
                      <div className="text-center">
                        <div className="text-base md:text-lg font-bold text-blue-600 font-sans">4</div>
                        <div className="text-xs text-gray-600 font-sans">Active</div>
                      </div>
                      <div className="text-center">
                        <div className="text-base md:text-lg font-bold text-emerald-600 font-sans">5</div>
                      ...
                      <div key={index} className="flex items-center justify-between p-2 md:p-3 bg-gray-50 rounded-lg">
                        <div className="flex items-center flex-1">
                          <div className="flex-1">
                            <div className="flex items-center space-x-2 mb-1">
                              <div className="font-medium text-gray-900 text-xs md:text-sm font-sans">{customer.name}</div>
                              {customer.active && (
                                <div className="flex items-center">
                            ...
                            <div className="flex items-center space-x-2 md:space-x-3 text-xs text-gray-600">
                              <div className="flex items-center">
                        ...
                        <div className="flex items-center space-x-1 md:space-x-2">
                          <div className="text-right mr-2">
                            <div className="flex items-center">
                              <div className="w-8 md:w-12 bg-gray-200 rounded-full h-1.5 mr-1 md:mr-2">
                                <div 
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 lg:order-2">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 font-sans">Complete Brand Customization</h3>
                </div>
                <p className="text-base md:text-lg text-gray-600 mb-6 font-sans">
          ...
          <div className="mb-16 md:mb-24">
            <div className="text-center mb-12">
              <div className="flex items-center justify-center mb-6">
                ...
                <h3 className="text-2xl md:text-3xl font-bold text-gray-900 font-sans">Multiple Step Types</h3>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
              {[
                ...
                <div key={index} className="bg-white border border-gray-200 rounded-xl p-4 md:p-6 hover:border-emerald-300 hover:shadow-md transition-all">
                  <div className="text-center mb-4">
                    <div className="text-3xl mb-3">{stepType.icon}</div>
                    <h4 className="text-base md:text-lg font-semibold text-gray-900 font-sans">{stepType.type}</h4>
                  </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden">
                  ...
                  <div className="p-6">
                    <div className="grid grid-cols-2 gap-4 md:gap-6 mb-6">
                      <div className="text-center">
                        <div className="text-xl md:text-2xl font-bold text-emerald-600 font-sans">5/5</div>
                        <div className="text-sm text-gray-600 font-sans">Steps Completed</div>
                      </div>
                      <div className="text-center">
                        <div className="text-xl md:text-2xl font-bold text-blue-600 font-sans">1.8</div>
              ...
              <div className="order-1 lg:order-2">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 font-sans">Delightful Completion Experience</h3>
                </div>
                <p className="text-base md:text-lg text-gray-600 mb-6 font-sans">
